        ...
        <form className="search-module w-[40rem] h-[15rem] flex flex-col">
          <div className="filter-selection flex flex-row justify-between space-x-5 mt-5">
            <div className="source-select w-[20rem]">
              <div className="relative">
                <label className=" text-[10px] absolute left-2 top-1/2 transform -translate-y-1/2 text-app_primary">Nguồn
                  truyện</label>
                <select id="countries"
            ...
            <div className="categories-select w-[20rem]">
              <div className="relative">
                <label className=" text-[10px] absolute left-2 top-1/2 transform -translate-y-1/2 text-app_primary">Thể
                  loại
                </label>
          ...
          <div className="search-input flex flex-row mt-5">
            ...
            <button type="submit"
                    ...
                    className="hover:opacity-60 p-5 ms-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800
