...
export const NovelDetails = () => {
  ...
  useEffect(() => {
    const fetchNovelDetail = async (novelSlug: any, server: any) => {// TODO: create model for this please
      let result: any;
          ...
          </button>
          {
            isAvailable ?
              <div className="novel-cover p-[2rem] flex flex-row">
                ...
                <div className="outer-wrapper flex flex-col justify-between ml-[5rem]">
                  ...
                  <div className="bottom-action flex flex-row">
                    ...
                    {
                      sources.map((source) => (
                        <Button key={source.name} className={`border-app_primary text-app_primary border-2 ml-2 ${source.name !== selectedServer ? 'bg-white' : 'bg-app_primary text-white'}`} placeholder={undefined}
                          onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined} onClick={() => handleSelectSever(source.name)}>
                          {source.name}
                        </Button>
                      ))
                    }
              ...
              <div className="outer-wrapper flex flex-col justify-between ml-[5rem]">
                ...
                <div className="bottom-action flex flex-row">
                  <Button className="bg-app_tertiary" placeholder={undefined} disabled
                    onPointerEnterCapture={undefined} onPointerLeaveCapture={undefined}>
                    Đọc ngay
                  </Button>
                  {
